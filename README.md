...
More data and the results of the experiments can be found [here](https://github.com/ZhangZhuoSJTU/StochFuzz-data). An example case of leveraging StochFuzz to speedup an advanced AFL-based fuzzer can be found in [system.md](docs/system.md#case-polyglot).
