...
Originally, StochFuzz is integrated into AFL, which makes an easy development. However, as more and more advanced fuzzing tools (e.g., [Polyglot](https://github.com/s3team/Polyglot)) take their own implementations (e.g., building a variant of AFL), it becomes hard to combine StochFuzz with these tools. 
